...
import com.dark.frost.databinding.ActivityImageBinding
import com.dark.frost.facebook.FB_IMAGE_ID_MATCHER
import com.dark.frost.facebook.get
import com.dark.frost.facebook.requests.call
import com.dark.frost.facebook.requests.getFullSizedImageUrl
import com.dark.frost.facebook.requests.requestBuilder
import com.dark.frost.services.LocalService
import com.dark.frost.utils.ARG_COOKIE
import com.dark.frost.utils.ARG_IMAGE_URL
import com.dark.frost.utils.ARG_TEXT
import com.dark.frost.utils.Prefs
import com.dark.frost.utils.frostSnackbar
import com.dark.frost.utils.frostUriFromFile
import com.dark.frost.utils.isIndirectImageUrl
import com.dark.frost.utils.logFrostEvent
import com.dark.frost.utils.sendFrostEmail
...
class ImageActivity : KauBaseActivity() {
    ...
    companion object {
        ...
        private const val IMG_TAG = "Speedy"
        const val PURGE_TIME: Long = 10 * 60 * 1000 // 10 min block
        private val L = KauLoggerExtension("Image", com.dark.frost.utils.L)
