...
import com.dark.frost.BuildConfig
...
import com.dark.frost.db.currentCookie
import com.dark.frost.db.getTabs
import com.dark.frost.enums.MainActivityLayout
import com.dark.frost.facebook.FbCookie
import com.dark.frost.facebook.FbItem
import com.dark.frost.facebook.parsers.FrostSearch
import com.dark.frost.facebook.parsers.SearchParser
import com.dark.frost.facebook.profilePictureUrl
import com.dark.frost.fragments.BaseFragment
import com.dark.frost.fragments.WebFragment
import com.dark.frost.services.scheduleNotificationsFromPrefs
import com.dark.frost.utils.ACTIVITY_SETTINGS
import com.dark.frost.utils.BiometricUtils
import com.dark.frost.utils.EXTRA_COOKIES
import com.dark.frost.utils.L
import com.dark.frost.utils.MAIN_TIMEOUT_DURATION
import com.dark.frost.utils.Prefs
import com.dark.frost.utils.REQUEST_FAB
import com.dark.frost.utils.REQUEST_NAV
import com.dark.frost.utils.REQUEST_NOTIFICATION
import com.dark.frost.utils.REQUEST_REFRESH
import com.dark.frost.utils.REQUEST_RESTART
import com.dark.frost.utils.REQUEST_RESTART_APPLICATION
import com.dark.frost.utils.REQUEST_SEARCH
import com.dark.frost.utils.REQUEST_TEXT_ZOOM
import com.dark.frost.utils.cookies
//import com.theme.frost.utils.frostChangelog
import com.dark.frost.utils.frostEvent
import com.dark.frost.utils.frostNavigationBar
import com.dark.frost.utils.launchLogin
...
import com.dark.frost.views.BadgedIcon
import com.dark.frost.views.FrostVideoViewer
import com.dark.frost.views.FrostViewPager
import com.dark.frost.widgets.NotificationWidget
...
//                frostChangelog()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_upgrade -> {
                materialDialog {
                    title(R.string.upgrade_popup_title)
                    message(R.string.upgrade_message)
                    positiveButton(R.string.upgrade_popup_yes) {

                        //buy pro version store app link
                        val uri = Uri.parse("market://details?id=it.dark.pro.")
