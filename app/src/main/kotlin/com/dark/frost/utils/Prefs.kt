...
import com.dark.frost.enums.FACEBOOK_BLUE
import com.dark.frost.enums.FeedSort
import com.dark.frost.enums.MainActivityLayout
import com.dark.frost.enums.Theme
import com.dark.frost.injectors.InjectorContract
...
object Prefs : KPref() {
    ...
    var theme: Int by kpref("theme", 2) { _: Int ->
        loader.invalidate()
    }
    ...
    /*    if (!BuildConfig.DEBUG) {
            if (it) {               Bugsnag.setAutoCaptureSessions(true)
    ...
    var linksInDefaultApp: Boolean by kpref("link_in_default_app", true)
    ...
    var showCreateFab: Boolean by kpref("show_create_fab", false)
