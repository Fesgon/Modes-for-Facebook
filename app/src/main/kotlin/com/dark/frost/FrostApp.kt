...
import com.dark.frost.services.setupNotificationChannels
import com.dark.frost.utils.FrostPglAdBlock
...
/*    private fun initBugsnag() {
       ...
       // if (!BuildConfig.APPLICATION_ID.startsWith("com.pitchedapps.frost")) {
        if (!BuildConfig.APPLICATION_ID.startsWith("com.pitchedapps.frost")) {if (!BuildConfig.APPLICATION_ID.startsWith("com.pitchedapps.frost")) {
            return
        }
